		...
		<tr>
			...
			<td>
				<p>
					...
					<a target="_blank" rel="noopener noreferrer" href="https://preventdirectaccess.com/docs/iis-web-server-support/"><?php _e( 'as per this instruction', 'prevent-direct-access' ); ?></a>:
				</p>
