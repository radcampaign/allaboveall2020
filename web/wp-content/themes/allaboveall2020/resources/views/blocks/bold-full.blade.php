      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="letter-block">
            ...
            @endif
            <div class="content">
              <h3 class="text-uppercase font-bold headline-smaller mt-0">{!! $block['data']['b_info_b_title'] !!}</h3>
        ...
        <div class="col-lg-6">
          <div class="letter-block">
            ...
            @endif
            <div class="content">
              <h3 class="text-uppercase font-bold headline-smaller mt-0">{!! $block['data']['o_info_o_title'] !!}</h3>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="letter-block">
            ...
            @endif
            <div class="content">
              <h3 class="text-uppercase font-bold headline-smaller mt-0">{!! $block['data']['l_info_l_title'] !!}</h3>
        ...
        <div class="col-lg-6">
          <div class="letter-block">
            ...
            @endif
            <div class="content">
              <h3 class="text-uppercase font-bold headline-smaller mt-0">{!! $block['data']['d_info_d_title'] !!}</h3>
